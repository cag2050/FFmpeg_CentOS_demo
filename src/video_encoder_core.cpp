...
//https://blog.csdn.net/lizhijian21/article/details/102795395
...
int32_t init_video_encoder(const char *codec_name) {
    ...
    // 这里的宽和高，要设置成具体输入的yuv文件的宽和高；否则报错：
    //    Error: Read data error, frame_size:1382400, read_size:691200
    //    Error: read_yuv_to_frame failed.
